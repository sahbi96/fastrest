  ...
  return loading ? (
    ...
    <div className="order">
      <div className="order-place">
        <div className="order-brand-logo">fastRest</div>
        ...
        <div className="email-confirmation">
          We will be sending a  confirmation email when the item is
          delivered !
        </div>

        <div className="appreciate-form">
          <div className="thanks">
            <div className="thanks-content">Thanks and welcome</div>
            <div className="representative">fastRest team</div>
          </div>
          <div className="contact">
            <div className="contact-title">Need help?</div>
            <div className="contact-number">Call us - +99841242258</div>
          </div>
        </div>
      </div>
    </div>
